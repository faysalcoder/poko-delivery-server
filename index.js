...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@poko.g0ojg.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`;
...
async function run() {
    try {
        ...
        const database = client.db('PokoDelivery');
